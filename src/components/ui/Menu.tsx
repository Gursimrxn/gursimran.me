    ...
    return (
        <div className="sm-scope w-full h-full">
            <div
                className={
                    (className ? className + " " : "") +
                    "-menu-wrapper relative w-full h-full z-40"
                }
                style={
                    accentColor
                        ? ({
            ...
            >
                ...
                <header
                    className="-menu-header relative bg-transparent max-w-7xl mx-auto w-full pt-3 pointer-events-none z-20 xl:px-0 px-4"
                ...
                <aside
                    id="-menu-panel"
                    ref={panelRef}
                    className="-menu-panel absolute top-0 right-0 h-full bg-white flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px]"
                    ...
                    <div className="sm-panel-inner flex-1 flex flex-col gap-5">
                        ...
                        {displaySocials &&
                            ...
                            socialItems.length > 0 && (
                                ...
                                >
                                    <h3 className="sm-socials-title m-0 text-base font-medium [color:var(#0767FB)]">
                                        Socials
                                    </h3>
                                    <ul
            ...
            <style>{`
.sm-scope .-menu-wrapper { position: relative; width: 100%; height: 100%; z-index: 40; }
.sm-scope .-menu-header { display: flex; align-items: center; justify-content: space-between; background: transparent; pointer-events: none; z-index: 20; }
.sm-scope .-menu-header > * { pointer-events: auto; }
