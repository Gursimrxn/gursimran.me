                ...
                <div className="flex flex-col w-full md:w-1/2 gap-3">
                    ...
                    <div className="flex items-center justify-between px-1">
                        ...
                        <div className="flex items-center gap-2">
                            <Link href="https://github.com/gursimrxn" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-black transition-colors p-1.5" aria-label="GitHub">
                            ...
                            <Link href="https://linkedin.com/in/gursimrxnsingh" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-black transition-colors p-1.5" aria-label="LinkedIn">
                            ...
                            <Link href="https://leetcode.com/gursimrxn" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-black transition-colors p-1.5" aria-label="LeetCode">
                            ...
                            <Link href="https://x.com/gursimrxnsingh" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-black transition-colors p-1.5" aria-label="X (Twitter)">
                            ...
                            <Link href="https://instagram.com/mysticaltrack.wav" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-black transition-colors p-1.5" aria-label="Instagram">
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex flex-col md:w-1/2 gap-6 px-4 w-full">
                    ...
                    <div className="flex flex-col gap-2 pt-4 border-t border-gray-200">
                        ...
                        <p className="text-sm text-gray-700">
                            ...
                            {" "}(Founder & CEO) — a gamified financial management RPG for Gen Z, and exploring Rust for systems programming
                        </p>
                    </div>
